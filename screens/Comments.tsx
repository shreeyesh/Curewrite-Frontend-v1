  ...
  return (
    <>
      <View style={styles.comments}>
        ...
        <View style={[styles.commentsInner, styles.groupChild2Bg]} />
        <TouchableHighlight
        ...
        <View style={[styles.groupParent, styles.groupLayout]}>
          <View style={[styles.rectangleGroup, styles.groupLayout]}>
            ...
            />
            <Text style={[styles.experimentalModelOf, styles.homeTypo]}>
            ...
            >
              ...
              >
                <Image
                  style={[styles.icon, styles.iconLayout, styles.iconLayout1]}
                  resizeMode="cover"
                  source={require("../assets/vuesaxlineararrowup2.png")}
                />
              </TouchableHighlight>
            </Pressable>
          ...
          <View style={styles.groupContainer}>
            ...
            <Pressable
              style={styles.drMinAkhterContainer}
              onPress={() => navigation.navigate("NetworkProfiles2")}
            >
              <Text style={styles.drMinAkhter}>Dr. Min Akhter</Text>
            </Pressable>
        ...
        <View style={styles.networkParent}>
          ...
          >
            ...
            />
            <Image
              style={[styles.basicsArrowLeft, styles.containerLayout]}
              resizeMode="cover"
