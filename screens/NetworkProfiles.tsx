      ...
      <View style={[styles.groupView, styles.groupLayout2]}>
        ...
        <View style={[styles.groupWrapper, styles.groupLayout1]}>
          <View style={[styles.groupContainer, styles.groupLayout1]}>
            <View style={[styles.groupContainer, styles.groupLayout1]}>
              <Text style={[styles.mbbs, styles.mbbsTypo]}>MBBS</Text>
              <Text
                style={[
                  styles.drSunnyFernandes,
                  styles.yrTypo,
                  styles.yrTypo1,
                  styles.aboutClr,
                ]}
...
`}</Text>
            ...
            >
              ...
              <View style={[styles.rectangleParent5, styles.groupChild6Layout]}>
                <View
                  style={[
                    styles.groupChild6,
      ...
      >
        ...
        >
          <Text style={[styles.sendRequest, styles.sTypo]}>Send Request</Text>
        </TouchableHighlight>
      </TouchableHighlight>
      <Image
        style={[styles.networkProfilesItem, styles.sPosition]}
        resizeMode="cover"
        source={require("../assets/ellipse-2.png")}
      />
      <Text style={[styles.s, styles.sPosition, styles.sTypo]}>S</Text>
    </View>
  );
};
